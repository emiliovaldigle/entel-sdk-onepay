...
function getCredentials(options) {
  ...
  httpRequest.open('POST', SOCKET_CREDENTIALS_URL);
  httpRequest.setRequestHeader('Content-Type', 'application/json');
  const httpBody = {
    "appScheme": "android/intent",
    "callbackUrl": "http://localhost:8081/services/transbankadaptor/api/web-pay-mall/transaction-finish/111/111/111",
    "generateOttQrCode": true,
    "channel": "WEB",
    "widthHeight": 100,
    "commerceLogoUrl": "http://www.entel.cl/personas/home/public/images/entel-menu/entel-logo.png?v=10",
    "externalUniqueNumber": "1234",
    "items": [{
      "description":"recarga preprower",
      "quantity": 1,
      "amount": 5000,
      "additionalData":"peo",
      "expire": 204040594053
